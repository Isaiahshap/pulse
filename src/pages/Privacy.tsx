      ...
      <main className="bg-blackPulse text-white min-h-screen">
        ...
        <section className="relative h-[40vh] overflow-hidden pt-24">
          ...
          <div className="relative h-full max-w-7xl mx-auto px-4 flex flex-col justify-center">
            ...
            >
              Terms of Service<span className="text-orangePulse">.</span>
            </motion.h1>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            >
              <div className="space-y-8">
                ...
                <h2 className="text-3xl font-display">Demo Terms of Service</h2>
                <p className="font-athletic text-greyPulse leading-relaxed">
                  This is a demonstration website. These terms of service are for demonstration purposes only 
                  and do not constitute a real legal agreement.
                </p>
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <p className="font-athletic text-greyPulse">
                      This is a demonstration site created to showcase web development skills. 
                      No real services are provided, and no actual terms are enforced.
                    </p>
                  </motion.div>
                </div>
              </div>
